...
/** Ugly SVG strings. Not sure how we should actually handle this. */
public final class Icons {
  ...
  /** Used to denote QuestionType.TEXT */
  public static String GOOGLE_MATERIAL_HELP_OUTLINE =
  ...
  /** Used to denote QuestionTYpe.ADDRESS */
  public static String GOOGLE_MATERIAL_PLACE =
  ...
  /** Used to denote QuestionTYpe.NAME */
  public static String GOOGLE_MATERIAL_ACCOUNT_CIRCLE =
  ...
  public static ContainerTag renderSvg(String pathString, int size) {
    return renderSvg(pathString, size, size);
  }

  public static ContainerTag renderSvg(String pathString, int width, int height) {
    return renderSvg(pathString).attr("viewBox", String.format("0 0 %1$d %2$d", width, height));
  }

  public static ContainerTag renderSvg(String pathString) {
